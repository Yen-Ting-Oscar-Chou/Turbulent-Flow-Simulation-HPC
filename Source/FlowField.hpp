...
class FlowField {
private:
  static FlowField* mapFlowFieldToGPU(int hostDevice, int targetDevice, FlowField& flowField) {
  ...
  static RealType* mapRHSToGPU(int hostDevice, int targetDevice, FlowField& flowField, FlowField* flowFieldGPU) {
  ...
  static RealType* mapPressureToGPU(int hostDevice, int targetDevice, FlowField& flowField, FlowField* flowFieldGPU) {
  ...
  static int* mapFlagsToGPU(int hostDevice, int targetDevice, FlowField& flowField, FlowField* flowFieldGPU) {
  ...
  static RealType* mapVelocityToGPU(int hostDevice, int targetDevice, FlowField& flowField, FlowField* flowFieldGPU) {
  ...
  static RealType* mapFGHToGPU(int hostDevice, int targetDevice, FlowField& flowField, FlowField* flowFieldGPU) {
...
#pragma omp end declare target
  ...
  static FlowFieldGPUPtrs mapToGPU(int hostDevice, int targetDevice, FlowField& flowField) {
    FlowField* flowFieldGPU    = mapFlowFieldToGPU(hostDevice, targetDevice, flowField);
