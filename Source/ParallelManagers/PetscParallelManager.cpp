...
ParallelManagers::PetscParallelManager::PetscParallelManager(Parameters& parameters, FlowField& flowField):
  ...
  _parallelBoundaryPressureFillIterator(_flowField, parameters, _pressureBufferFillStencil, 2, -1),
  _parallelBoundaryPressureReadIterator(_flowField, parameters, _pressureBufferReadStencil, 2, -1),
