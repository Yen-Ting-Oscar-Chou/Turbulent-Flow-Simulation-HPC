...
template <class FlowFieldType>
void Stencils::VTKStencil<FlowFieldType>::writeVTKHeader(std::ostream& file) const {
...
template <class FlowFieldType>
void Stencils::VTKStencil<FlowFieldType>::openFile(int timeStep, RealType simulationTime) {
  written_ = false;
...
template <class FlowFieldType>
void Stencils::VTKStencil<FlowFieldType>::closeFile() {
  ofile_.close();
}

template class Stencils::VTKStencil<FlowField>;
template class Stencils::VTKStencil<TurbulentFlowField>;