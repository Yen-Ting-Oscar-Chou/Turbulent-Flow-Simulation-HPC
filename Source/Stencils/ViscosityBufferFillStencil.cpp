...
void Stencils::ViscosityBufferFillStencil::applyLeftWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j) {
  bufferLeft_[j - 1] = flowField.getViscosity().getScalar(i + 1, j);
}

void Stencils::ViscosityBufferFillStencil::applyRightWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j) {
  bufferRight_[j - 1] = flowField.getViscosity().getScalar(i - 1, j);
}


void Stencils::ViscosityBufferFillStencil::applyBottomWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j) {
  bufferBottom_[i - 1] = flowField.getViscosity().getScalar(i, j + 1);
}

void Stencils::ViscosityBufferFillStencil::applyTopWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j) {
  bufferTop_[i - 1] = flowField.getViscosity().getScalar(i, j - 1);
}

/* Methods for 3D case */

void Stencils::ViscosityBufferFillStencil::applyLeftWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  bufferLeft_[j - 1 + (flowField.getNy() + 2) * (k - 1)] = flowField.getViscosity().getScalar(i + 1, j, k);
}

void Stencils::ViscosityBufferFillStencil::applyRightWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  bufferRight_[j - 1 + (flowField.getNy() + 2) * (k - 1)] = flowField.getViscosity().getScalar(i - 1, j, k);
}

void Stencils::ViscosityBufferFillStencil::applyBottomWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  bufferBottom_[i - 1 + (flowField.getNx() + 2) * (k - 1)] = flowField.getViscosity().getScalar(i, j + 1, k);
}

void Stencils::ViscosityBufferFillStencil::applyTopWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  bufferTop_[i - 1 + (flowField.getNx() + 2) * (k - 1)] = flowField.getViscosity().getScalar(i, j - 1, k);
}

void Stencils::ViscosityBufferFillStencil::applyFrontWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  bufferFront_[i - 1 + (flowField.getNx() + 2) * (j - 1)] = flowField.getViscosity().getScalar(i, j, k + 1);
}

void Stencils::ViscosityBufferFillStencil::applyBackWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
