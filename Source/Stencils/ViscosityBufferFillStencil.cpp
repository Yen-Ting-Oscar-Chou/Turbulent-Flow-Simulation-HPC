...
void Stencils::ViscosityBufferFillStencil::applyRightWall(TurbulentFlowField& flowField, int i, int j) {
  viscosityRight_[j - 1] = flowField.getViscosity().getScalar(i, j);
}
