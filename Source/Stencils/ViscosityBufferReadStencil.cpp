...
// 2D case
void Stencils::ViscosityBufferReadStencil::applyLeftWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j) {
  flowField.getViscosity().getScalar(i, j) = bufferLeft_[j - 1];
}

void Stencils::ViscosityBufferReadStencil::applyRightWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j) {
  flowField.getViscosity().getScalar(i, j) = bufferRight_[j - 1];
}

void Stencils::ViscosityBufferReadStencil::applyBottomWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j) {
  flowField.getViscosity().getScalar(i, j) = bufferBottom_[i - 1];
}

void Stencils::ViscosityBufferReadStencil::applyTopWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j) {
  flowField.getViscosity().getScalar(i, j) = bufferTop_[i - 1];
}

// 3D case
void Stencils::ViscosityBufferReadStencil::applyLeftWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  flowField.getViscosity().getScalar(i, j, k) = bufferLeft_[j - 1 + (flowField.getNy() + 2) * (k - 1)];
}
void Stencils::ViscosityBufferReadStencil::applyRightWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  flowField.getViscosity().getScalar(i, j, k) = bufferRight_[j - 1 + (flowField.getNy() + 2) * (k - 1)];
}
void Stencils::ViscosityBufferReadStencil::applyBottomWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  flowField.getViscosity().getScalar(i, j, k) = bufferBottom_[i - 1 + (flowField.getNx() + 2) * (k - 1)];
}
void Stencils::ViscosityBufferReadStencil::applyTopWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  flowField.getViscosity().getScalar(i, j, k) = bufferTop_[i - 1 + (flowField.getNx() + 2) * (k - 1)];
}
void Stencils::ViscosityBufferReadStencil::applyFrontWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
  flowField.getViscosity().getScalar(i, j, k) = bufferFront_[i - 1 + (flowField.getNx() + 2) * (j - 1)];
}
void Stencils::ViscosityBufferReadStencil::applyBackWall([[maybe_unused]] const Parameters& parameters, TurbulentFlowField& flowField, int i, int j, int k) {
